...
public class HelloWorld {
  ...
  public static void create_simple_design() {
    ...
    Cell and2 =
        d.createAndPlaceCell("and2", Unisim.AND2, "SLICE_X100Y100/A6LUT");
    Cell button0 =
        d.createAndPlaceIOB("button0", PinType.IN, "D19", "LVCMOS33");
    Cell button1 =
        d.createAndPlaceIOB("button1", PinType.IN, "D20", "LVCMOS33");
  ...
  static public void main(String[] args) {
    // create design that reads luts
    create_simple_design();
  }
}